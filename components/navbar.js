        ...
        <nav className={navbarStyles}>
            ...
            <div className="hidden md:flex md:space-x-4 md:items-center" style={{ marginLeft: '20px', marginTop: '20px'} }>
                ...
                <a
                    ...
                    className="px-5 py-2 inline-block text-lg font-medium ml-8 text-white bg-blue-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50 transition duration-300 ease-in-out hover:bg-white hover:text-black"
                >
                    Get Started
                </a>
            </div>
